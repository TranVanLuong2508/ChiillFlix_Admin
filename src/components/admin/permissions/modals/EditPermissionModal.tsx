...
export function EditPermissionModal({ open, permissionId, onClose, onSuccess }: ModalProps) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const res = await PermmissionService.CallUpdatePermission(permissionId!, payload);
    ...
    return (
        <Dialog open={open} onOpenChange={handleCloseModal} modal={true}>
            <DialogContent className="max-w-2xl w-full max-h-[90vh] overflow-y-auto p-6 hide-scrollbar">
                <DialogHeader>
                    <DialogTitle className="text-2xl font-bold">Chỉnh sửa Permission</DialogTitle>
                </DialogHeader>
                ...
                <div className="mt-6 space-y-6">
                    ...
                    <div className="flex justify-end gap-3 pt-4 border-t">
                        ...
                        <Button
                            ...
                            disabled={loading || !name.trim() || !apiPath.trim() || !module || !method}
