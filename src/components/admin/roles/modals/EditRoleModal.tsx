    ...
    const init = async () => {
      try {
        ...
        if (roleRes && roleRes?.EC === 1) {
          ...
          const existingPermissions = role.rolePermission?.map((p: any) => p.permissionId) || [];
          console.log("Check selected perrmission", existingPermissions);
