...
export function CommentFiltersComponent({
    ...
    const hasActiveFilters = filters.filmId || filters.isHidden || filters.userName;
    const activeFilterCount = [filters.filmId, filters.isHidden, filters.userName].filter(Boolean).length;
