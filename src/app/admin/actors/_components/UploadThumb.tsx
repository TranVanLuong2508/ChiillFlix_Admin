    ...
    return (
        <div className="flex flex-col gap-3 w-full rounded-xl border border-gray-200 shadow-sm p-4 bg-white">
            <div className="flex flex-row items-center w-full justify-between gap-2">
                <label className="relative inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-lg shadow-sm cursor-pointer hover:bg-blue-50 transition-colors" style={{ minWidth: 120 }}>
                    <input
                        type="file"
                        accept="image/*"
